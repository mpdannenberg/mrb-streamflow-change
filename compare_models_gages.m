...
r = corr(T.HEMO(ib), mean(Q(ia,:), 2), 'rows','pairwise');
text(lim(2), lim(1), sprintf('R = %.02f', r), 'HorizontalAlignment','right', 'VerticalAlignment','bottom', 'FontSize',7)
text(diff(lim)*0.04, lim(2), 'd', 'FontSize',12, 'VerticalAlignment','middle')
...
ylabel('Q (m^{3} s^{-1})')
ylim = get(gca, 'YLim');
text(1931, ylim(2), 'e', 'FontSize',12, 'VerticalAlignment','middle')
...
r = corr(T.HEMO(ib), mean(Q(ia,:), 2), 'rows','pairwise');
text(lim(2), lim(1), sprintf('R = %.02f', r), 'HorizontalAlignment','right', 'VerticalAlignment','bottom', 'FontSize',7)
text(diff(lim)*0.04, lim(2), 'f', 'FontSize',12, 'VerticalAlignment','middle')
