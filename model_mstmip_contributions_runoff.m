...
WB_RG1_unscaled = WB_RG1;
WB_SG1_unscaled = WB_SG1;
WB_SG2_unscaled = WB_SG2;
WB_SG3_unscaled = WB_SG3;
...
save('./data/MsTMIP_WaterBudget.mat', 'year', 'lat', 'lon', 'models',...
    'ET_RG1','ET_SG1','ET_SG2','ET_SG3','WB_RG1','WB_SG1','WB_SG2','WB_SG3',...
    'WB_RG1_unscaled','WB_SG1_unscaled','WB_SG2_unscaled','WB_SG3_unscaled','P', '-v7.3');
