...
lgd = legend([p1 p2 p3],...
    sprintf('gage (trend = %0.02f \x00B1 %0.02f m^3 s^{-1} yr^{-1})',beta(1),se(1)*1.96),...
    sprintf('MsTMIP (R = %0.02f; trend = %0.02f \x00B1 %0.02f m^3 s^{-1} yr^{-1})',r_mstmip,beta(2),se(2)*1.96),...
    sprintf('MW11 (R = %0.02f; trend = %0.02f \x00B1 %0.02f m^3 s^{-1} yr^{-1})',r_wbm,beta(3),se(3)*1.96), 'Location','northwest');
legend('boxoff')
lgd.Position(2) = 0.28;
